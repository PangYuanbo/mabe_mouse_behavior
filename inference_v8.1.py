"""
V8.1 Optimized Inference Script
Key improvements over V8:
1. Motion gating (velocity thresholds for escape/chase/freeze)
2. Fine-tuned class-specific thresholds
3. Optimized boundary refinement
4. Advanced postprocessing with smoothing kernel=3
"""
...
def main():
    parser = argparse.ArgumentParser(description='V8.1 Optimized Inference with Motion Gating')
    parser.add_argument('--checkpoint', type=str, default='checkpoints/v8.1_optimized/best_model.pth')
    parser.add_argument('--config', type=str, default='configs/config_v8.1_optimized.yaml')
    parser.add_argument('--data_dir', type=str, default=None)
    parser.add_argument('--output', type=str, default='submission_v8.1.csv')
