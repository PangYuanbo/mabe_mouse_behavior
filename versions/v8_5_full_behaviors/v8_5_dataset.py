"""
V8.5 Dataset - Multi-task labels (Action + Agent + Target)
...
class V85Dataset(Dataset):
    """
    V8.5 Dataset with multi-task labels
    Returns: keypoints, action_labels, agent_labels, target_labels

    Key improvement: Includes ALL 37 behaviors (not just 27)
    """
...
def create_v85_dataloaders(
    ...
    """
    Create V8.5 train and validation dataloaders

    Returns:
        train_loader, val_loader
    """
    train_dataset = V85Dataset(
        data_dir=data_dir,
        split='train',
