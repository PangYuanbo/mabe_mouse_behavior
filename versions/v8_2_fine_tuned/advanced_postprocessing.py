"""
V8.2 Fine-Tuned Post-processing for Interval Detection
Improvements over V8.1:
1. Validation smoothing kernel = 3 (better for short segments)
2. Further lowered sniff* thresholds (0.25-0.28) for recall
3. Larger sniffbody merge_gap for better segment merging
...
# V8.2: Further fine-tuned class-specific configurations
CLASS_CONFIG = {
    # Sniffing behaviors (V8.2: further lowered thresholds for recall)
    'sniff': {
        'min_duration': 6,
        'prob_threshold': 0.38,
        'merge_gap': 5,
    ...
    'sniffgenital': {
        'min_duration': 3,
        'prob_threshold': 0.25,  # V8.2: lowered from 0.26
        'merge_gap': 5,
        'frac_high_threshold': 0.20
    },
    'sniffface': {
        'min_duration': 3,
        'prob_threshold': 0.26,  # V8.2: lowered from 0.28
        'merge_gap': 5,
        'frac_high_threshold': 0.20
    },
    'sniffbody': {
        'min_duration': 4,
        'prob_threshold': 0.25,  # V8.2: lowered from 0.28
        'merge_gap': 8,  # V8.2: increased from 6 for better merging
        'frac_high_threshold': 0.20
    },
    'reciprocalsniff': {
        'min_duration': 4,
