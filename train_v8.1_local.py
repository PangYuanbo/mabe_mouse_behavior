...
def main():
    parser = argparse.ArgumentParser(description='V8.1 Optimized Multi-task Training')
    parser.add_argument('--config', type=str, default='configs/config_v8.1_optimized.yaml')
    ...
    print("="*60)
    print("V8.1 Optimized Multi-task Behavior Detection")
    print("Motion Gating + Fine-tuned Thresholds")
    print("="*60)
